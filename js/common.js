...
export function getRecordUrl(habit) {
...
export function getConfig(url) {
    let configData = getJsonData(url)
    if (configData == null) {
        console.log('miss config data: ' + url)
    }
    return configData
}

export function getRecordData(url) {
    let recordData = getJsonData(url)
    if (recordData == null) {
        console.log('miss record data: ' + url)
    }
    return recordData
}
